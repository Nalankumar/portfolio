...
export default function Carousel() {
    ...
    <div className='flex justify-center items-center w-[80vw]'>
      <div className='grid gap-3 md:gap-8 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2'>
            {data.projects.map((d)=>(
                 <div className='box-border w-[50vw] h-[40vh] rounded-xl bg-sky-500 items-center justify-evenly md:w-[25vw] md:h-[30vh] lg:w-[] lg:h-[]'>
                    ...
                    {/* <Project name={d.name} link={d.link}></Project>                     */}
                </div>
            ))}
        </div>
    </div>
